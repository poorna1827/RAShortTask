...
module_path = r"C:\Users\yutongzhao\Desktop\Research\wt\mini_wt\TWS_API\source\pythonclient"
...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.csvfile = open(r'C:\FinTech\wt_data\time_diff\measure_order_output_20240528.csv', 'w', newline='')
    ...
    def notify_order(self, order):
        print('notify_order is executed.')
        ...
        if order.status in [order.Submitted, order.Accepted]:
            ...
            print('Order Submitted or Accepted at:', self.order_created_time)
            return
    ...
    def next(self, frompre=False):
        ...
        row = [local_time, data_datetime, time_diff, self.data.open[0], self.data.high[0], self.data.low[0],
               ...
               self.order_created_time, self.executed_time, self.execution_time_diff, self.executed_price,
               self.executed_value, self.executed_comm]
