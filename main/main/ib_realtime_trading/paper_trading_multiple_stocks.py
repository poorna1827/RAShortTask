...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.csvfile = open(r'C:\FinTech\mini_wt\time_diff\test_order_20240208_1.csv', 'w', newline='')
...
if __name__ == '__main__':
    ...
    # args['data0'] = 'AAPL-STK-SMART-USD'
    stocks = ['AAPL-STK-SMART-USD', 'GOOG-STK-SMART-USD', 'AMZN-STK-SMART-USD', 'TSLA-STK-SMART-USD', 'NVDA-STK-SMART-USD']
    # new_args = AO(args)
    for stock in stocks:
        args['data0'] = stock
        new_args = AO(args)
