...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.csvfile = open(r'C:\wt\mini_wt\time_diff\test_order_20240208_1.csv', 'w', newline='')
    ...
    def next(self, frompre=False):
        ...
        data1_datetime = bt.num2date(self.data1.datetime[0])
        ...
        # Ensure data_datetime is localized to Eastern Time
        if data1_datetime.tzinfo is None or data1_datetime.tzinfo.utcoffset(data1_datetime) is None:
            data1_datetime = eastern.localize(data1_datetime.replace(tzinfo=None))
        else:
            data1_datetime = data1_datetime.astimezone(eastern)
        time_diff_data1 = (local_time - data1_datetime).total_seconds()
        ...
        # CSV writing
        row = [self.data._name, local_time, data_datetime, time_diff, self.data.open[0], self.data.high[0], self.data.low[0],
        ...
        if(len(self.data1)):
            ...
            # CSV writing
            row = [self.data1._name, local_time, data1_datetime, time_diff_data1, self.data1.open[0], self.data1.high[0],
                   self.data1.low[0],
                   self.data1.close[0], self.data1.volume[0], self.data1.openinterest[0],
