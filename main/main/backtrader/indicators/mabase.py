...
class MovingAverage(object):
    ...
    Instantiating a SimpleMovingAverage can be achieved as follows::
      ...
      ma = MovingAverage.Simple(self.data, period)

    Or using the shorter aliases::

      ma = MovAv.SMA(self.data, period)

    or with the full (forwards and backwards) names:

      ma = MovAv.SimpleMovingAverage(self.data, period)

      ma = MovAv.MovingAverageSimple(self.data, period)
