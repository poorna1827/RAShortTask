...
input_dir = r'C:\FinTech\mini_wt\data\finance_database'
output_dir = r'C:\FinTech\mini_wt\data\finance_database_adjusted'
...
for csv_file in csv_files:
    ...
    output_file_path = os.path.join(output_dir, f'{os.path.splitext(csv_file)[0]}_fdb_adjusted.csv')
