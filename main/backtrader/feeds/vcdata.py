...
from mini_wt.main.backtrader import TimeFrame, date2num, num2date
from mini_wt.main.backtrader.feed import DataBase
from mini_wt.main.backtrader.metabase import MetaParams
from mini_wt.main.backtrader.utils.py3 import (integer_types, queue, string_types,
                                  with_metaclass)

from mini_wt.main.backtrader.stores import vcstore
...
class VCData(with_metaclass(MetaVCData, DataBase)):
    ...
    Params:
      ...
      - ``usetimezones`` (default: ``True``)
        ...
        allows for datetime to be converted to market time (*bt* choice
        for representation)
