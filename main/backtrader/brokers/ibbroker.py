...
from mini_wt.main.backtrader.feed import DataBase
from mini_wt.main.backtrader import (TimeFrame, num2date, date2num, BrokerBase,
                        Order, OrderBase, OrderData)
from mini_wt.main.backtrader.utils.py3 import bytes, bstr, with_metaclass, queue, MAXFLOAT
from mini_wt.main.backtrader.metabase import MetaParams
from mini_wt.main.backtrader.comminfo import CommInfoBase
from mini_wt.main.backtrader.position import Position
from mini_wt.main.backtrader.stores import ibstore
from mini_wt.main.backtrader.utils import AutoDict, AutoOrderedDict
from mini_wt.main.backtrader.comminfo import CommInfoBase
...
class IBOrder(OrderBase, ibapi.order.Order):
    ...
    ib.ext.Order.Order object, which could be used as follows::
      ...
      ``bt`` are not enough, in the case of for example
      *Interactive Brokers* the following could be passed as *kwargs*::

        orderType='LIT', lmtPrice=10.0, auxPrice=9.8

      This would override the settings created by ``bt`` and
    ...
    # Map bt order types to the ib specifics
    _IBOrdTypes = {
